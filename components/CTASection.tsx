  ...
  return (
    <section id="cta-section" className="py-12 sm:py-16 md:py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className={`relative z-20 max-w-4xl mx-auto text-center text-white transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        ...
        <Link
          href="/contact"
          className="group inline-flex items-center px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-500 hover:to-blue-400 rounded-xl hover:shadow-glow-blue transition-all duration-300 text-white font-semibold text-sm sm:text-base hover:scale-105 transform shadow-lg hover:shadow-blue-500/50"
        >
          CONTACT US
