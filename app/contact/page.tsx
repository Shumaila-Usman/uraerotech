...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative h-[200px] sm:h-[250px] md:h-[300px] lg:h-[400px] overflow-hidden mt-20">
        ...
        <div className="relative z-10 h-full flex items-center">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-white mb-3 sm:mb-4">Contact Us</h1>
      ...
      <main className="pb-12 sm:pb-16 md:pb-20 px-4 sm:px-6 lg:px-8 relative">
                ...
                {success ? (
                  <div className="text-center py-12">
                    ...
                    <button
                      ...
                      className="px-6 sm:px-8 py-2.5 sm:py-3 bg-gradient-aviation rounded-lg hover:shadow-glow-blue transition-all text-white font-semibold text-sm sm:text-base"
                    >
            ...
            <ScrollAnimation animation="fadeIn" delay={250}>
              <div className="bg-gradient-to-br from-blue-600/20 via-indigo-600/15 to-sky-600/20 backdrop-blur-md border border-blue-400/30 rounded-xl p-4 sm:p-6 shadow-xl">
                ...
                <div className="space-y-2 sm:space-y-3">
                  <Link
                    href="/quote"
                    className="block w-full px-4 sm:px-6 py-2.5 sm:py-3 bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-500 hover:to-blue-400 rounded-lg hover:shadow-glow-blue transition-all text-white font-semibold text-center text-sm sm:text-base"
                  >
                    Request a Quote
                  </Link>
                  <Link
